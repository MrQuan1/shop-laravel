...
@endsection
@section('title','văn phòng phẩm || Chi Tiết Sản Phẩm')
											...
											<div class="short">
                                                ...
                                                <p class="price">
                                                    @if($discount > 0)
                                                        ...
                                                        <s style="margin-left: 8px;">{{ number_format($price, 0) }}đ</s>
                                                    @else
                                                ...
                                                @if ($product_detail->cat_info)
                                                    <p class="cat">
                                                        ...
                                                        <a href="{{ route('product-cat', $product_detail->cat_info['slug']) }}">
                                                            {{ $product_detail->cat_info['title'] ?? 'Không có tên' }}
                                                        </a>
                                                    </p>
                                                @endif
                                                ...
                                                @if ($product_detail->sub_cat_info && $product_detail->cat_info)
                                                    <p class="cat mt-1">
                                                        ...
                                                        <a href="{{ route('product-sub-cat', [
                                                                    $product_detail->cat_info['slug'],
                                                                    $product_detail->sub_cat_info['slug']
                                                                ]) }}">
                                                            {{ $product_detail->sub_cat_info['title'] ?? 'Không có tên' }}
                                                        </a>
                                                    </p>
                                                @endif
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            @endif                                             {{-- <span class="out-of-stock">Hot</span> --}}
                                        </a>
