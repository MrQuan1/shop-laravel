...
@section('title','văn phòng phẩm || Chi Tiết Bài Viết')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{ isset($post->allComments) && $post->allComments ? $post->allComments->count() : 0 }})</a></span>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Bình luận ({{ isset($post->allComments) && $post->allComments ? $post->allComments->count() : 0 }})</h3>
                                    <!-- Single Comment -->
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            ...
                            <ul class="categor-list">
                                {{-- {{count(\App\Helpers::postCategoryList())}} --}}
                                @foreach(\App\Helpers::postCategoryList('posts') as $cat)
