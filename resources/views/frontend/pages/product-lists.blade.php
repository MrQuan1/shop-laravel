...
@section('title','văn phòng phẩm || Sản Phẩm')
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget range">
                                ...
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        @php
                                            $max=DB::table('products')->max('price') ?? 1000000;
                                        @endphp
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price">
                                                    @if($discount > 0)
                                                        @php
                                                            $org = $price - ($price * $discount / 100);
                                                        @endphp
                                                        <span>{{ number_format($org, 0) }}đ</span>
                            ...
                            <div class="single-widget category">
                                ...
                                <ul class="categor-list">
                                    @php
                                        $brands=DB::table('brands')->orderBy('title','ASC')->get();
                                    @endphp
                                    @if($brands && count($brands) > 0)
                                        @foreach($brands as $brand)
                                            @if(isset($brand->slug) && isset($brand->title))
                                                    ...
                                                    <div class="product-img">
                                                        ...
                                                        <div class="button-head">
                                                            <div class="product-action">
                                                                <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Xem quả sản phẩm</span></a>
                                                ...
                                                <div class="list-content">
                                                    <div class="product-content">
                                                        <div class="product-price">
                                                            ...
                                                            @if($discount > 0)
                                                                <del class="old-price">{{ number_format($price, 0) }}đ</del>
                                                            @endif
                                                        </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-wrap">
                                                <div class="quickview-ratting">
                                                    @php
                                                        ...
                                                        $rate_count=DB::table('product_reviews')->where('product_id',$product->id)->count() ?? 0;
                                                    @endphp
                                                    @for($i=1; $i<=5; $i++)
                                                        @if($rate>=$i)
                                        ...
                                        <h3>
                                            @if($discount > 0)
                                                <small><del class="text-muted">{{number_format($price,0)}}đ</del></small>
                                            @endif
