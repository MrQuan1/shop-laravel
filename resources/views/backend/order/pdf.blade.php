...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>{{env('APP_ADDRESS')}}</p>
      <p>Số điện thoại: 0000000</p>
        <p>Địa chỉ: Cầu Giấy-Hà Nội</p>
      <p>Email: codedoan.com@gmail.com</p>
    </div>
    ...
    <table class="table table-bordered table-stripe">
      ...
      {{-- @if(!empty($order->coupon))
        <tr>
          ...
          <th scope="col"><span>-{{$order->coupon->discount(Helpers::orderPrice($order->id, $order->user->id))}}{{Helpers::base_currency()}}</span></th>
        </tr>
      @endif --}}
