        ...
        <div class="card-body">
            <form method="post" action="{{route('brand.update',$brand->id)}}">
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="title" placeholder="Nhập tên thương hiệu" value="{{$brand->title}}" class="form-control">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input id="inputSlug" type="text" name="slug" placeholder="Slug" value="{{$brand->slug}}" class="form-control" readonly>
                    @error('slug')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
